...
- **Arquivos de Teste Ativos (40 arquivos, 535 testes automatizados aprovados 100% verde):**
  1. `src/screens/illustratedBriefings.test.tsx` (6 testes - Briefings Ilustrados Canônicos para Bubble, Selection, Insertion e Merge Sort, e integridade da arquitetura de 4 regiões do ProtocolCard)
  2. `src/screens/mergeIntegrationFlow.test.tsx` (7 testes - Fluxo de Integração do Merge Sort: Hub, Tutorial com conclusão factual, Demonstração observacional sem efeitos colaterais, Gravação canônica v4, Conclusão inter-sessões 3/3 e Ação de Repetição)
  3. `src/screens/mergePracticeFlow.test.tsx` (26 testes - Estação de Intercalação Desktop-First, Confluência de Ramais, Buffer Auxiliar, Despacho Estável com Prioridade Esquerda, Drenagem Sem Comparações, Ações Bloqueadas, Telemetria Segregada de Escritas, Roteamento no App e Fallback Procedural de Duplicatas)
  4. `src/screens/mergeReplayScreen.test.tsx` (8 testes - Replay de Merge Sort com pseudocódigo de 30 linhas sincronizado, frentes fáticas passadas e controles de transporte temporal)
  5. `src/game/sorting/merge/mergeReplayModel.test.ts` (8 testes - Modelo funcional puro de replay e invariante 1+N quadros)
  6. `src/game/sorting/merge/mergeReplayPseudocode.test.ts` (7 testes - Mapeamento de 30 linhas canônicas para quadros do Merge Sort)
  7. `src/game/sorting/merge/mergeSortEngine.test.ts` (22 testes - Engine Pura, Casos Base, Recorrência n=4,5,6, Estabilidade, Drenagem Lateral e Reconstrução via History)
  8. `src/game/sorting/merge/mergeConstraints.test.ts` (14 testes - Constraints, Predicado de Confronto Real, Rótulos Estáveis e Catálogo)
  9. `src/game/sorting/merge/mergeTutorialGuide.test.ts` (5 testes - Vetor [4a, 1, 3, 4b], 5 comps, 16 escritas, Desempate Reflexivo e Recuperação de Erro)
  10. `src/game/demonstration/mergeDemonstration.test.ts` (8 testes - Vetor [7, 2, 5, 3], 5 comps, 16 escritas, Histórico e Visual Step Frames)
  11. `src/game/briefing/mergeBriefing.test.ts` (4 testes - 7 Pontos Pedagógicos, Destaques Canônicos e Blindagem contra FSM)
  12. `src/game/persistence/persistence.test.ts` (69 testes - Schema v4, Gravação Única, Merge Sort namespaces, Isolamento Estrito e Integridade Factual de Tutorial)
  13. `src/screens/protocolCatalog.test.ts` (16 testes - 4 Protocolos Disponíveis com Merge Sort ativo)
  14. `src/game/sorting/selection/selectionSortEngine.test.ts` (18 testes)
  15. `src/game/sorting/insertion/insertionSortEngine.test.ts` (18 testes)
  16. `src/game/replay/selectionReplayPseudocode.test.ts` (9 testes)
  17. `src/game/sorting/insertion/insertionReplayModel.test.ts` (13 testes)
  18. `src/game/briefing/briefing.test.ts` (20 testes)
  19. `src/game/curriculum/practiceCatalog.test.ts` (11 testes - Catálogo Curricular Transversal)
  20. `src/screens/practiceFlow.test.tsx` (8 testes - Integração de Seletor, Conclusão de Práticas e Cenário Cross-Sessão)
  21. `src/game/generation/arrayGenerator.test.ts` (31 testes)
  22. `src/game/sorting/bubbleSortEngine.test.ts` (39 testes)
  23. `src/game/replay/replayModel.test.ts` (11 testes)
  24. `src/game/sorting/selection/selectionCampaign.test.ts` (19 testes)
  25. `src/game/demonstration/demonstration.test.ts` (24 testes)
  26. `src/game/replay/replayPseudocode.test.ts` (12 testes)
  27. `src/game/sorting/selection/selectionConstraints.test.ts` (16 testes)
  28. `src/game/replay/selectionReplayModel.test.ts` (9 testes)
  29. `src/game/sorting/insertion/insertionReplayPseudocode.test.ts` (8 testes)
  30. `src/game/sorting/selection/selectionTutorialGuide.test.ts` (3 testes)
  31. `src/game/sorting/insertion/insertionPracticeGameplay.test.ts` (13 testes)
  32. `src/game/sorting/insertion/insertionConstraints.test.ts` (10 testes)
  33: `src/game/sorting/insertion/insertionTutorialGuide.test.ts` (3 testes)
  34: `src/game/session/protocolScore.test.ts` (11 testes)
  35: `src/game/sorting/insertion/practiceCatalog.test.ts` (5 testes)
  36: `src/game/tutorial/tutorialGuide.test.ts` (5 testes)
  37: `src/game/campaign/campaignSummary.test.ts` (4 testes)
  38: `src/game/sorting/insertion/insertionPedagogy.test.ts` (6 testes)
  39: `src/screens/campaignCompleteConfig.test.ts` (3 testes)
  40: `src/game/session/sessionMetrics.test.ts` (5 testes)
