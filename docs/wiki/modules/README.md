...
| **03** | **Insertion Sort** | [`insertion-sort.md`](./insertion-sort.md) | $O(n^2) / O(n^2)$ | Elevação de chave (*lift*), deslocamento regressivo na partição ordenada e inserção na lacuna | `PLANEJADO` (Marco P2.2) |
