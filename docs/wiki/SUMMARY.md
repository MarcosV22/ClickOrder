...
| **03. Insertion Sort** | `PLANEJADO` | Metadados no catálogo (`protocolCatalog.ts`) com status "EM BREVE". Próxima prioridade de código da plataforma (Marco P2.2). | [`modules/insertion-sort.md`](./modules/insertion-sort.md) |
